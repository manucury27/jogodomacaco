...
function gerarNuvens(){
 ...
 function gerarSerpente(){
  if(frameCount %300 === 0){
    serpente = createSprite(width -1200,height-100,40,10);
...
function gerarMirtilo(){
  if(frameCount %120 === 0){
   mirtilo = createSprite(Math.round(random(width -50,width -900)), Math.round(random(height -100,height -900)),40,10);
...
function gerarAmora(){
  if(frameCount %60 === 0){
   amora = createSprite(Math.round(random(width -900,width -1000)), Math.round(random(height -100,height-900)),40,10);
...
function gerarBanana(){
  if(frameCount %60 === 0){
   banana= createSprite(Math.round(random(width -900,width -1000)), Math.round(random(height -100,height-900)),40,10);
...
function gerarMorango(){
  if(frameCount %60 === 0){
   morango = createSprite(Math.round(random(width -900,width -1000)), Math.round(random(height -100,height-900)),40,10);
